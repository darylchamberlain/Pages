    ...
    render() {
        return (
            ...
            <div className="Manager">
                <h2>Art Manager</h2>
                <p className="Address">Hit Promotional Products Largo, FL - 2016 to 2020</p>
            ...
            <div className="Supervisor">
                ...
                <p className="Address">Hit Promotional Products Largo, FL - 2014 to 2016</p>
            </div>
            <div className="Designer">
                <h2>Graphic Designer</h2>
                <p className="Address">Hit Promotional Products Largo, FL - 2010 to 2014</p>
            </div>
            <div className="Artist">
                <h2>Production Artist</h2>
                <p className="Address">Hit Promotional Products Largo, FL - 2008 to 2010</p>
            </div>
